...
<!-- Mirrored from seantheme.com/color-admin-v1.9/admin/html/page_with_boxed_layout.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Apr 2016 04:11:16 GMT -->
<head>
	<meta charset="utf-8" />
				...
				<ul class="nav">
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu">
                            ...
                            <li class="active"><a href="page_with_boxed_layout.html">Page with Boxed Layout <i class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
