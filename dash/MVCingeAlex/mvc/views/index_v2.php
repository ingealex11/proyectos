...
<!-- Mirrored from seantheme.com/color-admin-v1.9/admin/html/index_v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Apr 2016 03:16:16 GMT -->
<head>
	<meta charset="utf-8" />
				...
				<ul class="nav">
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu">
						    ...
						    <li class="active"><a href="index_v2.php">Dashboard v2</a></li>
						</ul>
					</li>
					<li class="has-sub">
						<a href="javascript:;">
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
						    <li><a href="http://seantheme.com/color-admin-v1.9/frontend/one-page-parallax/index.php" target="_blank">One Page Parallax</a></li>
						    <li><a href="http://seantheme.com/color-admin-v1.9/frontend/blog/index.php" target="_blank">Blog</a></li>
						    <li><a href="http://seantheme.com/color-admin-v1.9/frontend/forum/index.php" target="_blank">Forum</a></li>
						</ul>
					</li>
					<li class="has-sub">
					    <a href="javascript:;">
					...
					<li class="has-sub">
					    ...
					    <ul class="sub-menu">
					        ...
					        <li><a href="http://seantheme.com/color-admin-v1.9/admin/ajax/index.php">AJAX</a></li>
					        <li><a href="http://seantheme.com/color-admin-v1.9/admin/angularjs/index.php">ANGULAR JS<i class="fa fa-paper-plane text-theme m-l-5"></i></a></li>
					    </ul>
					</li>
					<li class="has-sub">
					    <a href="javascript:;">
...
<!-- Mirrored from seantheme.com/color-admin-v1.9/admin/html/index_v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Apr 2016 03:18:44 GMT -->
</html>
