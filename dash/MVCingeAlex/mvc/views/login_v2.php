...
<!-- Mirrored from seantheme.com/color-admin-v1.9/admin/html/login_v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Apr 2016 04:11:22 GMT -->
<head>
	<meta charset="utf-8" />
	...
	<div id="page-container" class="fade">
        ...
        <div class="login login-v2" data-pageload-addclass="animated fadeIn">
            ...
            <div class="login-content">
                <form action="<?php echo "../controller/Controller.php?accion=login";?>" method="POST" class="margin-bottom-0">
                    <div class="form-group m-b-20">
                        <input type="text" class="form-control input-lg" placeholder="Correo Electronico" name="email" />
                    </div>
                    <div class="form-group m-b-20">
                    ...
                    <div class="m-t-20">
                       Ha Olvidado Su <a href="#">Contraseña</a>?.
                    </div>
                </form>
            </div>
        </div>
...
<!-- Mirrored from seantheme.com/color-admin-v1.9/admin/html/login_v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Apr 2016 04:12:49 GMT -->
</html>
