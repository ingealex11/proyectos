...
<!-- Mirrored from seantheme.com/color-admin-v1.9/admin/html/email_detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Apr 2016 04:04:10 GMT -->
<head>
	<meta charset="utf-8" />
				...
				<ul class="nav">
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu">
						    ...
						    <li class="active"><a href="email_detail.php">Detail</a></li>
						</ul>
					</li>
					<li class="has-sub">
						<a href="javascript:;">
                    ...
                    <div class="wrapper bg-silver-lighter clearfix">
                        ...
                        <div class="pull-right">
                            <div class="btn-group btn-toolbar">
                                <a href="inbox_v2.php" class="btn btn-white btn-sm disabled"><i class="fa fa-arrow-up"></i></a>
                                <a href="inbox_v2.php" class="btn btn-white btn-sm"><i class="fa fa-arrow-down"></i></a>
                            </div>
                            <div class="btn-group m-l-5">
                                <a href="inbox_v2.php" class="btn btn-white btn-sm"><i class="fa fa-times"></i></a>
                            </div>
                        </div>
                    </div>
		            <!-- end wrapper -->
...
<!-- Mirrored from seantheme.com/color-admin-v1.9/admin/html/email_detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Apr 2016 04:04:21 GMT -->
</html>
