...
<head>
	<meta charset="utf-8" />
	<title>Cadena De Ayudas | Pagina Para El Registro del Usuario</title>
        ...
        <div class="register register-with-news-feed">
            ...
            <div class="news-feed">
                <div class="news-image">
                    <img src="assets/img/login-bg/bg-3.jpg" alt="" />
                </div>
            ...
            <div class="right-content">
                ...
                <h1 class="register-header">
                    ...
                    <small>Añade tu usuario en Cadena de favores.Es gratis y siempre lo sera.</small>
                </h1>
                <!-- end register-header -->
                ...
                <div class="register-content">
                    <form action="http://localhost/MVCingeAlex/mvc/controller/Controller.php?accion=create" method="POST" class="margin-bottom-0" onsubmit="return validar();">
                        ...
                        <div class="checkbox m-b-30">
                            <label>
                                <input type="checkbox" id="condi"/> Al Dar Click en Registrar, Aceptas Nuestros <a href="page_blank.php">Terminos y Condiciones</a>
                            </label>
                        </div>
