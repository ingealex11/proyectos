...
<head>
	<meta charset="utf-8" />
	<title>Cadena De Favores | Pagina de Ingreso</title>
        ...
        <div class="login login-with-news-feed">
            ...
            <div class="news-feed">
                ...
                <div class="news-caption">
                    <h4 class="caption-title"><i class="fa fa-diamond text-success"></i>Ingresa Para Disfrutar los Beneficios</h4>
                    <p>
                        Con Cadena de Favores Obtenedras el Material Que Usted Necesita, Ingresa y Danos A Conocer Añadiendo Usuarios A Nuestra Plataforma.
                    </p>
                </div>
            </div>
            <!-- end news-feed -->
                ...
                <div class="login-content">
                    <form action="<?php echo "../controller/Controller.php?accion=login";?>" method="POST" class="margin-bottom-0">
                        ...
                        <div class="m-t-20 m-b-40 p-b-40">
                          ...
                          <br>
                           <a href="forgottenPassword.php" class="text-success">Ha Olvidado Su Contraseña?</a>
                        </div>
                        <hr />
