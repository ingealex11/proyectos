...
<!-- Mirrored from seantheme.com/color-admin-v1.9/admin/html/ui_widget_boxes.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Apr 2016 04:04:22 GMT -->
<head>
	<meta charset="utf-8" />
    ...
    <link href="assets/plugins/gritter-1.7.4/css/jquery.gritter.html" rel="stylesheet" />	
...
<body>
	...
	<div id="page-container" class="fade page-header-fixed page-sidebar-fixed">
		...
		<div id="content" class="content">
                    ...
                    <div class="panel panel-default panel-with-tabs" data-sortable-id="ui-widget-9">
                        <div class="panel-heading">
                            <ul id="myTab" class="nav nav-tabs pull-right">
                                ...
                                <li><a href="#profile" data-toggle="tab"><i class="fa fa-user"></i> <span class="hidden-xs">Profile</span></a></li>
                            </ul>
			...
			<p class="m-b-20">
			    You can customize the panel body background by adding predefined background class. E.g <code>.bg-black</code>. Full list of available predefined background class can be found <a href="helper_css.html">here</a>.
			</p>
			<!-- begin row -->
			<div class="row">
			    <!-- begin col-6 -->
...
<!-- Mirrored from seantheme.com/color-admin-v1.9/admin/html/ui_widget_boxes.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Apr 2016 04:04:23 GMT -->
</html>
