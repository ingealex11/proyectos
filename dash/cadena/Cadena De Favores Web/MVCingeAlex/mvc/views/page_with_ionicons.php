...
<!-- Mirrored from seantheme.com/color-admin-v1.9/admin/html/page_with_ionicons.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Apr 2016 04:11:16 GMT -->
<head>
	<meta charset="utf-8" />
				...
				<ul class="nav">
						...
						<ul class="sub-menu">
							...
							<li class="has-sub">
							    ...
							    <ul class="sub-menu">
							        ...
							        <li><a href="table_manage_rowreorder.html">RowReorder <i class="ion-paper-airplane text-theme"></i></a></li>
					...
					<li class="has-sub">
						...
						<ul class="sub-menu">
							...
							<li><a href="chart-d3.html">d3 Chart <i class="ion-paper-airplane text-theme"></i></a></li>
						</ul>
					</li>
					...
					<li class="has-sub active">
						...
						<ul class="sub-menu"><li><a href="page_blank.html">Blank Page</a></li>
                            ...
                            <li><a href="page_with_top_menu.html">Page with Top Menu <i class="ion-paper-airplane text-theme"></i></a></li>
                            <li><a href="page_with_boxed_layout.html">Page with Boxed Layout <i class="ion-paper-airplane text-theme"></i></a></li>
                            <li><a href="page_with_mixed_menu.html">Page with Mixed Menu <i class="ion-paper-airplane text-theme"></i></a></li>
                            <li><a href="page_boxed_layout_with_mixed_menu.html">Boxed Layout with Mixed Menu <i class="ion-paper-airplane text-theme"></i></a></li>
                            <li><a href="page_with_transparent_sidebar.html">Page with Transparent Sidebar <i class="ion-paper-airplane text-theme"></i></a></li>
						</ul>
					</li>
					<li class="has-sub">
						<a href="javascript:;">
					...
					<li class="has-sub">
					    ...
					    <ul class="sub-menu">
					        ...
					        <li><a href="http://seantheme.com/color-admin-v1.9/admin/angularjs/index.html">ANGULAR JS <i class="ion-paper-airplane text-theme"></i></a></li>
					    </ul>
					</li>
					<li class="has-sub">
					    <a href="javascript:;">
