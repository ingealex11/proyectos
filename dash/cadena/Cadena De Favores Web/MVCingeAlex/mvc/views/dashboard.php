...
?>		
		...
		<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Dashboard <small>Interfaz Principal De La Plataforma Para El Usuario</small></h1>
			<!-- end page-header -->
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6">
					<div class="widget widget-stats bg-green">
						...
						<div class="stats-info">
							...
							<p id="disp"><?php  $aux= new User();
									  $aux=$_SESSION["userObj"];
									  $numUser=$aux->getUsuariosRegistrados();
									  echo $_SESSION["cantRegist"]-$numUser;?></p>	
						</div>
				...
				<div class="col-md-3 col-sm-6">
					<div class="widget widget-stats bg-blue">
						...
						<div class="stats-info">
							<h4>Porcentaje de usuarios registrados</h4>
							<p><?php  echo (($_SESSION["userObj"]->getUsuariosRegistrados()*100)/$_SESSION["cantRegist"]."%")?></p>	
						</div>
						<div class="stats-link">
							<a href="javascript:;">Ver Detalles <i class="fa fa-arrow-circle-o-right"></i></a>
						</div>
				...
				<div class="col-md-3 col-sm-6">
					<div class="widget widget-stats bg-red">
						...
						<div class="stats-info">
							<h4>Tiempo Trasncurrido</h4>
							<p id="tiempo">00:12:23</p>	
						</div>
						<div class="stats-link">
							<a href="javascript:;">Ver Detalles<i class="fa fa-arrow-circle-o-right"></i></a>
						</div>
	...
	<script>
		...
		function tiempo(){
				...
				if ($seg<=9 && $min<=9){
					document.getElementById("tiempo").innerHTML=$hor+":0"+$min+":0"+$seg;
				}else{
					if ($seg<9){
						document.getElementById("tiempo").innerHTML=$hor+":"+$min+":0"+$seg;
					}else {
						if ($min<=9){
							document.getElementById("tiempo").innerHTML=$hor+":0"+$min+":"+$seg;
						}else{
							document.getElementById("tiempo").innerHTML=$hor+":"+$min+":"+$seg;
						}
					}
				}
		}
...
<!-- Mirrored from seantheme.com/color-admin-v1.9/admin/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Apr 2016 04:04:02 GMT -->
</html>
